...
public class ApolloTest {
    ...
    public void setUp() {
        try {
            ...
            testPlayer.setGodCard(Godcard.APOLLO);
    ...
    public void moveOkSpecialMove() {
        try {
            ...
            Assert.assertEquals(testGame.getPlayer(2).getWorker(21).getField(), testGame.getField(3,2));
        } catch (SantoriniException ex) {
            throw new ResponseStatusException(
                    ex.getException(), ex.toString(), ex);
        }
    ...
    public void allowedMoveOk() {
        ...
        Assert.assertSame(testGame.getField(2, 2).getWorker().getWorkerNr(), 21);
    ...
    public void allowedFieldsOk() {
        testGame.getPlayer(2).setGodCard(Godcard.APOLLO);
